...
open class Rectangle(
    ...
    companion object {
        fun getBoundingBox(rect1: Rectangle, rect2: Rectangle): Rectangle {
        ...
        fun getIntersection(rect1: Rectangle, rect2: Rectangle): Rectangle {
    ...
    fun isOverlappingWith(other: Rectangle): Boolean {
